...
$.widget("jui.juiBase", {
    ...
    var a = new TimelineMax({
        onComplete: function() {
            b.splitText("toggleSplitText");
        }
    }), b = $(".gsap-test").splitText();
    $("section"), $("span", b).each(function() {
        var b = $(this);
        b.css({
            position: "relative",
    ...
    function a(a, b) {
        return a = a || 40, b = b || 98, Math.random() * (b - a) + a;
    }
    $.widget("jui.tickingText", $.jui.splitText, {
        ...
        _create: function() {
            var a = this;
            a.element.css("visibility", "hidden"), a._super();
            var b = [], c = 0;
            a.options.revertTextOnCompletion && (a.options.revertTextInterval = setInterval(function() {
                a.options.clearedIntervalsCount > 0 && a.options.clearedIntervalsCount >= a.options.intervals.length && (a.toggleSplitText(), 
                clearInterval(a.options.revertTextInterval), a.element.trigger("ticking-text:complete"));
            })), $("span", a.element).each(function(d) {
                var e = $(this);
                e.fadeOut(0), function() {
                    var f = b.length;
                    b.push(setTimeout(function() {
                        a.animateSpansText(e, d), clearTimeout(b[f]);
                    }, c));
                }(), c += a.options.delayPerChar;
            }), a.element.css("visibility", "visible");
        },
        animateSpansText: function(b) {
            var c = this, d = c.options.intervals, e = d.length, f = b.text(), g = f + "", h = 0;
            b.fadeTo(c.options.fadeInSpeed, 1), d.push(setInterval(function() {
                return h === c.options.charChangeReps ? (b.text(f), clearInterval(d[e]), 
                e === d.length - 1 && c.element.trigger("ticking-text:complete"), c.options.clearedIntervalsCount += 1, 
                delete e, delete f, delete g, delete h, void 0) : (b.text(String.fromCharCode(a(c.options.minCharCode, c.options.maxCharCode))), 
                h += 1, void 0);
            }, c.options.charChangeSpeed));
        }
    });

...
$.widget("jui.juiBase", {
    ...
    _getElementFromOptions: function(a) {
        ...
        empty(c) ? null : c instanceof $ && c.length > 0 ? c : (isset(c.selector) && empty(c.create) && "string" == typeof c.selector && (c.elm = $(c.selector, b.element)), 
        !empty(c.html) && c.create && "string" == typeof c.html && (c.elm = this._createElementFromOptions(c), 
        isset(c.appendTo) && "string" == typeof c.appendTo && ("this.element" === c.appendTo ? c.elm = this.element.append(c.elm).find(c.selector) : "after this.element" === c.appendTo ? this.element.after(c.elm) : c.elm = this._getElementFromOptions("ui." + c.appendTo).append(c.elm).find(c.selector))), 
    ...
    getUiElement: function(a) {
        return isset(this.ui[a]) && this.ui[a] instanceof $ ? this.ui[a] : this._getElementFromOptions("ui." + a);
    },
